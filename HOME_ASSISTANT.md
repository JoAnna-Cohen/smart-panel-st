> **About this file:** this is the Home Assistant documentation from the upstream project,
> [rwoldberg/ldata-ha](https://github.com/rwoldberg/ldata-ha), kept here for reference. The Home Assistant
> integration in `custom_components/ldata/` is unchanged from upstream. To install it in Home Assistant,
> use the upstream repository (as the HACS steps below do). This fork's own README covers the SmartThings
> connector: see [README.md](README.md).
